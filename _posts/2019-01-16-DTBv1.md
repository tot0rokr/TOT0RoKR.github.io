...
일단 FDT에 대한 확장자 **".dtb" **의 약자는
[이게 공식(Device Tree Reference)](https://elinux.org/Device_Tree_Reference#FDT_format) 이다.
...
이 장치는 **메모리의 0x00000bad0000beef 위치에서 0x1000 byte만큼의 크기에 Mapping** 되어 있다는 의미이다. (물론 64비트 시스템일 것이다.)
